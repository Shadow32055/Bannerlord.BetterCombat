					...
					if (configFile.Exists) {
						try {
							...
							using (StreamReader stream = configFile.OpenText()) {
								...
								SettingsManager.instance.PlayerPercentHealthOnHit /= 100;

								SettingsManager.instance.TroopPercent /= 100;
								SettingsManager.instance.PlayerPercent /= 100;
								SettingsManager.instance.HeroPercent /= 100;
							}
